...
var AsgardeoProvider = ({
  ...
  const refetchBranding = useCallback7(async () => {
    setHasFetchedBranding(false);
    await fetchBranding();
  }, [fetchBranding]);
  useEffect5(() => {
...
var useAsgardeo = () => {
  const context = useContext2(AsgardeoContext_default);
  if (!context) {
...
var useUser = () => {
  const context = useContext3(UserContext_default);
  if (!context) {
...
var useOrganization = () => {
  const context = useContext4(OrganizationContext_default);
  if (!context) {
...
var useFlow = () => {
  const context = useContext5(FlowContext_default);
  if (!context) {
...
var useI18n = () => {
  const context = useContext6(I18nContext_default);
  if (!context) {
    throw new Error(
...
var useTheme = () => {
  const context = useContext7(ThemeContext_default);
  if (!context) {
...
var useForm = (config = {}) => {
  ...
  const [values, setFormValues] = useState8({ ...initialValues });
  const [touched, setFormTouched] = useState8({});
  const [errors, setFormErrors] = useState8({});
  const [isSubmitted, setIsSubmitted] = useState8(false);
  const getFieldConfig = useCallback8(
    (name) => fields.find((field) => field.name === name),
    [fields]
  );
  const validateField = useCallback8(
    (name) => {
  ...
  const validateForm = useCallback8(() => {
    const newErrors = {};
  ...
  const setValues = useCallback8((newValues) => {
    setFormValues((prev) => ({
      ...prev,
      ...newValues
    }));
  }, []);
  const setTouched = useCallback8(
    (name, isTouched = true) => {
      setFormTouched((prev) => ({
        ...prev,
        [name]: isTouched
  ...
  const setTouchedFields = useCallback8((touchedFields) => {
    setFormTouched((prev) => ({
      ...prev,
      ...touchedFields
    }));
  }, []);
  const touchAllFields = useCallback8(() => {
  ...
  const setError = useCallback8((name, error) => {
    setFormErrors((prev) => ({
      ...prev,
      [name]: error
    }));
  }, []);
  const setErrors = useCallback8((newErrors) => {
    setFormErrors((prev) => ({
      ...prev,
      ...newErrors
    }));
  }, []);
  const clearErrors = useCallback8(() => {
    setFormErrors({});
  }, []);
  ...
  const getFieldProps = useCallback8(
    (name) => {
      const fieldConfig = getFieldConfig(name);
      return {
...
import { forwardRef, useMemo as useMemo8 } from "react";
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs2(
      "button",
      {
        ...
        className: clsx2(
          withVendorCSSClassPrefix2("button"),
          withVendorCSSClassPrefix2(`button-${color}`),
          withVendorCSSClassPrefix2(`button-${variant}`),
          withVendorCSSClassPrefix2(`button-${size}`),
          {
            [withVendorCSSClassPrefix2("button-full-width")]: fullWidth,
            [withVendorCSSClassPrefix2("button-loading")]: loading
          },
          className
        ),
        ...
        children: [
          ...
          !loading && startIcon && /* @__PURE__ */ jsx9("span", { children: startIcon }),
          children && /* @__PURE__ */ jsx9(Fragment2, { children }),
          !loading && endIcon && /* @__PURE__ */ jsx9("span", { children: endIcon })
        ]
      }
    );
  }
...
var BaseSignInButton = forwardRef2(
  ({ children, className, style, signIn, isLoading, preferences, ...rest }, ref) => {
    if (typeof children === "function") {
      return /* @__PURE__ */ jsx10(Fragment3, { children: children({ isLoading, signIn }) });
    }
    return /* @__PURE__ */ jsx10(
      Button_default,
      {
        ref,
        className: clsx3(withVendorCSSClassPrefix3("sign-in-button"), className),
        style,
        disabled: isLoading,
        loading: isLoading,
        type: "button",
...
import { Fragment as Fragment4, jsx as jsx12 } from "react/jsx-runtime";
var BaseSignOutButton = forwardRef4(
  ({ children, className, style, signOut, isLoading, preferences, ...rest }, ref) => {
    if (typeof children === "function") {
      return /* @__PURE__ */ jsx12(Fragment4, { children: children({ isLoading, signOut }) });
    }
    return /* @__PURE__ */ jsx12(
      Button_default,
      {
        ref,
        className: clsx4(withVendorCSSClassPrefix4("sign-out-button"), className),
        style,
        disabled: isLoading,
        loading: isLoading,
        type: "button",
...
import { forwardRef as forwardRef5, useState as useState10 } from "react";
...
var BaseSignUpButton = forwardRef6(
  ({ children, className, style, signUp, isLoading, preferences, ...rest }, ref) => {
    if (typeof children === "function") {
      return /* @__PURE__ */ jsx14(Fragment5, { children: children({ isLoading, signUp }) });
    }
    return /* @__PURE__ */ jsx14(
      Button_default,
      {
        ref,
        className: clsx5(withVendorCSSClassPrefix5("sign-up-button"), className),
        style,
        disabled: isLoading,
        loading: isLoading,
        type: "button",
...
var SignedIn = ({
  ...
  if (!isSignedIn) {
    return /* @__PURE__ */ jsx16(Fragment6, { children: fallback });
  }
...
var SignedOut = ({
  ...
  return /* @__PURE__ */ jsx17(Fragment7, { children: fallback });
};
...
var AsgardeoLoading = ({
  ...
  if (!isLoading) {
    return /* @__PURE__ */ jsx18(Fragment8, { children: fallback });
  }
  return /* @__PURE__ */ jsx18(Fragment8, { children });
};
...
import {
  ...
  withVendorCSSClassPrefix as withVendorCSSClassPrefix16
} from "@asgardeo/browser";
import { clsx as clsx16 } from "clsx";
import { useEffect as useEffect12, useState as useState14, useCallback as useCallback9, useRef as useRef3, useMemo as useMemo12 } from "react";
...
var Typography = ({
  ...
  return /* @__PURE__ */ jsx19(
    ...
    {
      className: clsx6(
        withVendorCSSClassPrefix6("typography"),
        withVendorCSSClassPrefix6(`typography-${variant}`),
        {
          [withVendorCSSClassPrefix6("typography-noWrap")]: noWrap,
          [withVendorCSSClassPrefix6("typography-inline")]: inline,
          [withVendorCSSClassPrefix6("typography-gutterBottom")]: gutterBottom
        },
        className
      ),
...
var FormControl = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { style: containerStyle, className, children: [
    children,
    (error || helperText) && /* @__PURE__ */ jsx20(Typography_default, { variant: "caption", color: error ? "error" : "textSecondary", style: helperTextStyle, children: error || helperText })
  ] });
};
...
var InputLabel = ({
  ...
  return /* @__PURE__ */ jsxs4("label", { style: labelStyle, ...rest, children: [
    children,
    required && /* @__PURE__ */ jsx21("span", { style: { color: theme.vars.colors.error.main }, children: " *" })
  ] });
};
...
var TextField = ({
  ...
  return /* @__PURE__ */ jsxs5(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx7(withVendorCSSClassPrefix7("text-field"), className),
      style,
      children: [
        label && /* @__PURE__ */ jsx22(InputLabel_default, { required, error: !!error, children: label }),
        /* @__PURE__ */ jsxs5("div", { style: inputContainerStyle, children: [
          startIcon && /* @__PURE__ */ jsx22(
            "div",
            {
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix8 } from "@asgardeo/browser";
...
var Select = ({
  ...
  return /* @__PURE__ */ jsxs6(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx8(withVendorCSSClassPrefix8("select"), className),
      style,
      children: [
        label && /* @__PURE__ */ jsx23(InputLabel_default, { required, error: !!error, children: label }),
        /* @__PURE__ */ jsx23("select", { style: selectStyle, disabled, "aria-invalid": !!error, "aria-required": required, ...rest, children: options.map((option) => /* @__PURE__ */ jsx23("option", { value: option.value, children: option.label }, option.value)) })
      ]
    }
  );
};
...
import { useRef as useRef2, useEffect as useEffect6, useState as useState12 } from "react";
import clsx9 from "clsx";
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix9 } from "@asgardeo/browser";
...
var OtpField = ({
  ...
  const { theme } = useTheme_default();
  const [otp, setOtp] = useState12(Array(length).fill(""));
  ...
  return /* @__PURE__ */ jsxs7(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx9(withVendorCSSClassPrefix9("otp-input"), className),
      style,
      helperTextAlign: "center",
      children: [
        label && /* @__PURE__ */ jsx24(InputLabel_default, { required, error: !!error, children: label }),
        /* @__PURE__ */ jsx24("div", { style: inputContainerStyle, children: Array.from({ length }, (_, index) => /* @__PURE__ */ jsx24(
          "input",
          {
            ref: (el) => {
...
var Eye = (props) => /* @__PURE__ */ jsxs8(
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx25("path", { d: "M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0" }),
...
var EyeOff = (props) => /* @__PURE__ */ jsxs9(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx26("path", { d: "M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49" }),
      /* @__PURE__ */ jsx26("path", { d: "M14.084 14.158a3 3 0 0 1-4.242-4.242" }),
      /* @__PURE__ */ jsx26("path", { d: "M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143" }),
...
var PasswordField = ({
  ...
  return /* @__PURE__ */ jsx27(
    TextField_default,
    {
      ...
      endIcon: showPassword ? /* @__PURE__ */ jsx27(EyeOff_default, { width: 16, height: 16 }) : /* @__PURE__ */ jsx27(Eye_default, { width: 16, height: 16 }),
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix10 } from "@asgardeo/browser";
...
var DatePicker = ({
  ...
  return /* @__PURE__ */ jsxs10(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx10(withVendorCSSClassPrefix10("date-picker"), className),
      style,
      children: [
        label && /* @__PURE__ */ jsx28(InputLabel_default, { required, error: !!error, children: label }),
        /* @__PURE__ */ jsx28(
          "input",
          {
            type: "date",
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix11 } from "@asgardeo/browser";
...
var Checkbox = ({ label, error, className, required, helperText, style = {}, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx29(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx11(withVendorCSSClassPrefix11("checkbox"), className),
      helperTextMarginLeft: `calc(${theme.vars.spacing.unit} * 3.5)`,
      children: /* @__PURE__ */ jsxs11("div", { style: containerStyle, children: [
        /* @__PURE__ */ jsx29("input", { type: "checkbox", style: inputStyle, "aria-invalid": !!error, "aria-required": required, ...rest }),
...
var createField = (config) => {
  ...
  switch (type) {
    case FieldType.Password:
      return /* @__PURE__ */ jsx30(PasswordField_default, { ...commonProps, onChange });
    case FieldType.Text:
      return /* @__PURE__ */ jsx30(TextField_default, { ...commonProps, type: "text", onChange: (e) => onChange(e.target.value), autoComplete: "off" });
    case FieldType.Email:
      return /* @__PURE__ */ jsx30(TextField_default, { ...commonProps, type: "email", onChange: (e) => onChange(e.target.value), autoComplete: "email" });
    case FieldType.Date:
      return /* @__PURE__ */ jsx30(DatePicker_default, { ...commonProps, onChange: (e) => onChange(e.target.value) });
    case FieldType.Checkbox:
      const isChecked = value === "true" || value === true;
      return /* @__PURE__ */ jsx30(Checkbox_default, { ...commonProps, checked: isChecked, onChange: (e) => onChange(e.target.checked.toString()) });
    case FieldType.Otp:
      return /* @__PURE__ */ jsx30(OtpField_default, { ...commonProps, onChange: (e) => onChange(e.target.value) });
    case FieldType.Number:
...
// src/components/presentation/SignIn/options/UsernamePassword.tsx
import { Fragment as Fragment9, jsx as jsx31, jsxs as jsxs12 } from "react/jsx-runtime";
var UsernamePassword = ({
  ...
  return /* @__PURE__ */ jsxs12(Fragment9, { children: [
    formFields.map((param) => /* @__PURE__ */ jsx31("div", { style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: createField({
      name: param.param,
      type: param.type === EmbeddedSignInFlowAuthenticatorParamType.String ? param.confidential ? FieldType2.Password : FieldType2.Text : FieldType2.Text,
...
var IdentifierFirst = ({
  ...
  return /* @__PURE__ */ jsxs13(Fragment10, { children: [
    formFields.map((param) => /* @__PURE__ */ jsx32("div", { style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: createField({
      name: param.param,
      type: param.type === EmbeddedSignInFlowAuthenticatorParamType2.String ? param.confidential ? FieldType3.Password : FieldType3.Text : FieldType3.Text,
      label: param.displayName,
      required: authenticator.requiredParams.includes(param.param),
      value: formValues[param.param] || "",
      onChange: (value) => onInputChange(param.param, value),
...
var GoogleButton = ({
  ...
  return /* @__PURE__ */ jsx33(
    Button_default,
    {
      ...
      onClick: handleClick,
      className: buttonClassName,
      startIcon: /* @__PURE__ */ jsx33("svg", { width: "18", height: "18", viewBox: "0 0 67.91 67.901", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxs14("g", { transform: "translate(-0.001 -0.001)", children: [
        /* @__PURE__ */ jsx33(
          "path",
          {
...
var MicrosoftButton = ({
  ...
  return /* @__PURE__ */ jsx35(
    Button_default,
    {
      ...
      onClick: handleClick,
      className: buttonClassName,
      startIcon: /* @__PURE__ */ jsxs15("svg", { width: "14", height: "14", viewBox: "0 0 23 23", xmlns: "http://www.w3.org/2000/svg", children: [
...
var FacebookButton = ({
  ...
  return /* @__PURE__ */ jsx36(
    Button_default,
    {
      ...
      onClick: handleClick,
      className: buttonClassName,
      startIcon: /* @__PURE__ */ jsxs16("svg", { width: "18", height: "18", viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg", children: [
        /* @__PURE__ */ jsx36(
          "path",
          {
            fill: "#1976D2",
...
import { Fragment as Fragment11, jsx as jsx39, jsxs as jsxs17 } from "react/jsx-runtime";
var EmailOtp = ({
  authenticator,
  formValues,
  touchedFields,
  ...
  return /* @__PURE__ */ jsxs17(Fragment11, { children: [
    formFields.map((param) => {
      ...
      return /* @__PURE__ */ jsx39("div", { style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: isOtpParam && hasOtpField ? /* @__PURE__ */ jsx39(
        OtpField_default,
        {
          length: 6,
          value: formValues[param.param] || "",
        ...
        name: param.param,
        type: param.type === EmbeddedSignInFlowAuthenticatorParamType3.String ? param.confidential ? FieldType4.Password : FieldType4.Text : FieldType4.Text,
        label: param.displayName,
        required: authenticator.requiredParams.includes(param.param),
        value: formValues[param.param] || "",
        onChange: (value) => onInputChange(param.param, value),
...
import { Fragment as Fragment12, jsx as jsx40, jsxs as jsxs18 } from "react/jsx-runtime";
var Totp = ({
  authenticator,
  formValues,
  touchedFields,
  ...
  return /* @__PURE__ */ jsxs18(Fragment12, { children: [
    formFields.map((param) => {
      ...
      return /* @__PURE__ */ jsx40("div", { style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: isTotpParam && hasTotpField ? /* @__PURE__ */ jsx40(
        OtpField_default,
        {
          length: 6,
          value: formValues[param.param] || "",
        ...
        name: param.param,
        type: param.type === EmbeddedSignInFlowAuthenticatorParamType4.String ? param.confidential ? FieldType5.Password : FieldType5.Text : FieldType5.Text,
        label: param.displayName,
        required: authenticator.requiredParams.includes(param.param),
        value: formValues[param.param] || "",
        onChange: (value) => onInputChange(param.param, value),
...
import { Fragment as Fragment13, jsx as jsx41, jsxs as jsxs19 } from "react/jsx-runtime";
var SmsOtp = ({
  authenticator,
  formValues,
  touchedFields,
  ...
  return /* @__PURE__ */ jsxs19(Fragment13, { children: [
    formFields.map((param) => {
      const isOtpParam = param.param.toLowerCase().includes("otp") || param.param.toLowerCase().includes("code");
      return /* @__PURE__ */ jsx41("div", { style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: isOtpParam && hasOtpField ? /* @__PURE__ */ jsx41(
        OtpField_default,
        {
          length: 6,
          value: formValues[param.param] || "",
        ...
        name: param.param,
        type: param.type === EmbeddedSignInFlowAuthenticatorParamType5.String ? param.confidential ? FieldType6.Password : FieldType6.Text : FieldType6.Text,
        label: param.displayName,
        required: authenticator.requiredParams.includes(param.param),
        value: formValues[param.param] || "",
        onChange: (value) => onInputChange(param.param, value),
  ...
  const getIcon = () => {
    ...
    switch (authenticatorId) {
      case ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SmsOtp:
        return /* @__PURE__ */ jsx43("svg", { width: "18", height: "18", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx43(
          "path",
          {
            fill: "currentColor",
      ...
      case ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Totp:
        return /* @__PURE__ */ jsx43("svg", { width: "18", height: "18", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx43("path", { fill: "currentColor", d: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5z" }) });
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix12 } from "@asgardeo/browser";
...
var CircleCheck = (props) => /* @__PURE__ */ jsxs21(
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx45("circle", { cx: "12", cy: "12", r: "10" }),
      /* @__PURE__ */ jsx45("path", { d: "m9 12 2 2 4-4" })
    ]
  }
);
...
var CircleAlert = (props) => /* @__PURE__ */ jsxs22(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
var TriangleAlert = (props) => /* @__PURE__ */ jsxs23(
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx47("path", { d: "m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" }),
      /* @__PURE__ */ jsx47("path", { d: "M12 9v4" }),
      /* @__PURE__ */ jsx47("path", { d: "M12 17h.01" })
    ]
  }
);
...
var Info = (props) => /* @__PURE__ */ jsxs24(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx48("path", { d: "M12 16v-4" }),
      /* @__PURE__ */ jsx48("path", { d: "M12 8h.01" })
    ]
  }
);
  ...
  ({ variant = "info", showIcon = true, children, className, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsxs25(
      "div",
      {
        ...
        className: clsx12(withVendorCSSClassPrefix12("alert"), withVendorCSSClassPrefix12(`alert-${variant}`), className),
        ...rest,
        children: [
          showIcon && /* @__PURE__ */ jsx49("div", { style: iconStyle, className: withVendorCSSClassPrefix12("alert-icon"), children: /* @__PURE__ */ jsx49(IconComponent, {}) }),
          /* @__PURE__ */ jsx49("div", { style: contentStyle, className: withVendorCSSClassPrefix12("alert-content"), children })
        ]
      }
    );
  }
);
var AlertTitle = forwardRef8(({ children, className, style, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ jsx49(
    Typography_default,
    {
      ...
      className: clsx12(withVendorCSSClassPrefix12("alert-title"), className),
      ...filteredRest,
      children
    }
  );
  ...
  ({ children, className, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx49(
      Typography_default,
      {
        ...
        className: clsx12(withVendorCSSClassPrefix12("alert-description"), className),
        ...filteredRest,
        children
      }
    );
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix13 } from "@asgardeo/browser";
  ...
  ({ variant = "default", clickable = false, children, className, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx50(
      "div",
      {
        ...
        className: clsx13(
          withVendorCSSClassPrefix13("card"),
          withVendorCSSClassPrefix13(`card-${variant}`),
          {
            [withVendorCSSClassPrefix13("card-clickable")]: clickable
          },
          className
        ),
        ...rest,
...
var CardHeader = forwardRef9(({ children, className, style, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ jsx50(
    "div",
    {
      ...
      className: clsx13(withVendorCSSClassPrefix13("card-header"), className),
      ...rest,
      children
    }
  );
});
var CardTitle = forwardRef9(
  ({ children, level = 3, className, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx50(
      Typography_default,
      {
        ...
        style: { ...titleStyle, ...style },
        className: clsx13(withVendorCSSClassPrefix13("card-title"), className),
        fontWeight: 600,
        ...filteredRest,
        children
      }
...
var CardDescription = forwardRef9(
  ({ children, className, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx50(
      Typography_default,
      {
        ...
        color: "textSecondary",
        style: { ...descriptionStyle, ...style },
        className: clsx13(withVendorCSSClassPrefix13("card-description"), className),
        ...filteredRest,
        children
      }
    );
...
var CardAction = forwardRef9(({ children, className, style, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ jsx50(
    "div",
    {
      ...
      className: clsx13(withVendorCSSClassPrefix13("card-action"), className),
      ...rest,
      children
    }
  );
...
var CardContent = forwardRef9(({ children, className, style, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ jsx50(
    "div",
    {
      ...
      className: clsx13(withVendorCSSClassPrefix13("card-content"), className),
      ...rest,
      children
    }
  );
...
var CardFooter = forwardRef9(({ children, className, style, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ jsx50(
    "div",
    {
      ...
      className: clsx13(withVendorCSSClassPrefix13("card-footer"), className),
      ...rest,
      children
    }
  );
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix14 } from "@asgardeo/browser";
import { clsx as clsx14 } from "clsx";
import { useMemo as useMemo11 } from "react";
import { Fragment as Fragment14, jsx as jsx51, jsxs as jsxs26 } from "react/jsx-runtime";
var useStyles = (orientation, variant, color, hasChildren) => {
  ...
  return useMemo11(() => {
    ...
    const styles = `
      .${withVendorCSSClassPrefix14("divider")} {
        margin: calc(${theme.vars.spacing.unit} * 2) 0;
      }

      .${withVendorCSSClassPrefix14("divider--vertical")} {
      ...
      .${withVendorCSSClassPrefix14("divider--horizontal")} {
        display: flex;
        align-items: center;
        width: 100%;
      }

      .${withVendorCSSClassPrefix14("divider--horizontal")}:not(.${withVendorCSSClassPrefix14("divider--with-text")}) {
        height: 1px;
        border-top: 1px ${borderStyle} ${baseColor};
      }

      .${withVendorCSSClassPrefix14("divider__line")} {
        flex: 1;
        height: 1px;
        border-top: 1px ${borderStyle} ${baseColor};
      }

      .${withVendorCSSClassPrefix14("divider__text")} {
      ...
      /* @__PURE__ */ jsxs26(
        "div",
        {
          className: clsx14(
            withVendorCSSClassPrefix14("divider"),
            withVendorCSSClassPrefix14("divider--horizontal"),
            withVendorCSSClassPrefix14("divider--with-text"),
            className
          ),
          style,
          role: "separator",
          ...
          ...rest,
          children: [
            /* @__PURE__ */ jsx51("div", { className: withVendorCSSClassPrefix14("divider__line") }),
            /* @__PURE__ */ jsx51(
              Typography_default,
              {
                variant: "body2",
                color: "textSecondary",
                className: withVendorCSSClassPrefix14("divider__text"),
                inline: true,
                children
              }
            ),
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix15 } from "@asgardeo/browser";
...
var Logo = ({ className, src, alt, title, size = "medium", style }) => {
  ...
  const logoClasses = clsx15(withVendorCSSClassPrefix15("logo"), withVendorCSSClassPrefix15(`logo--${size}`), className);
  const sizeStyles = {
    small: {
      height: "32px",
      maxWidth: "120px"
  ...
  return /* @__PURE__ */ jsx52("img", { src: logoSrc, alt: logoAlt, title: logoTitle, className: logoClasses, style: defaultStyles });
};
...
var BaseSignIn = (props) => {
  ...
  return /* @__PURE__ */ jsxs27("div", { children: [
    /* @__PURE__ */ jsx53("div", { style: styles.logoContainer, children: /* @__PURE__ */ jsx53(Logo_default, { size: "large" }) }),
    /* @__PURE__ */ jsx53(FlowProvider_default, { children: /* @__PURE__ */ jsx53(BaseSignInContent, { ...props }) })
  ] });
};
var BaseSignInContent = ({
  ...
  const styles = useStyles2();
  const [isSignInInitializationRequestLoading, setIsSignInInitializationRequestLoading] = useState14(false);
  const [isInitialized, setIsInitialized] = useState14(false);
  const [currentFlow, setCurrentFlow] = useState14(null);
  const [currentAuthenticator, setCurrentAuthenticator] = useState14(null);
  ...
  const setupFormFields = useCallback9(
    (authenticator) => {
      const initialValues = {};
    ...
    try {
      ...
      if (response && "flowId" in response && "nextStep" in response) {
        ...
        if (nextStepResponse.nextStep?.authenticators?.length > 0) {
          if (nextStepResponse.nextStep.stepType === EmbeddedSignInFlowStepType.MultiOptionsPrompt && nextStepResponse.nextStep.authenticators.length > 1) {
  ...
  const hasMultipleOptions = useCallback9(
  ...
  const getAvailableAuthenticators = useCallback9(() => {
  ...
  const containerClasses = clsx16(
    [
      withVendorCSSClassPrefix16("signin"),
      withVendorCSSClassPrefix16(`signin--${size}`),
      withVendorCSSClassPrefix16(`signin--${variant}`)
    ],
    className
  );
  const inputClasses = clsx16(
    [
      withVendorCSSClassPrefix16("signin__input"),
      size === "small" && withVendorCSSClassPrefix16("signin__input--small"),
      size === "large" && withVendorCSSClassPrefix16("signin__input--large")
    ],
    inputClassName
  );
  const buttonClasses = clsx16(
    [
      withVendorCSSClassPrefix16("signin__button"),
      size === "small" && withVendorCSSClassPrefix16("signin__button--small"),
      size === "large" && withVendorCSSClassPrefix16("signin__button--large")
    ],
    buttonClassName
  );
  const errorClasses = clsx16([withVendorCSSClassPrefix16("signin__error")], errorClassName);
  const messageClasses = clsx16([withVendorCSSClassPrefix16("signin__messages")], messageClassName);
  useEffect12(() => {
    if (isLoading) {
      return;
    }
  ...
  if (!isInitialized && isLoading) {
    return /* @__PURE__ */ jsx53(Card_default, { className: containerClasses, style: styles.card, variant, children: /* @__PURE__ */ jsx53(Card_default.Content, { children: /* @__PURE__ */ jsxs27("div", { style: styles.loadingContainer, children: [
      /* @__PURE__ */ jsx53(Spinner_default, { size: "medium" }),
      /* @__PURE__ */ jsx53(Typography_default, { variant: "body1", style: styles.loadingText, children: t("messages.loading") })
    ] }) }) });
  }
  if (hasMultipleOptions() && !currentAuthenticator) {
    ...
    const userPromptAuthenticators = availableAuthenticators.filter(
      (auth) => auth.metadata?.promptType === EmbeddedSignInFlowAuthenticatorPromptType.UserPrompt || // Fallback: LOCAL authenticators with params are typically user prompts
    ...
    return /* @__PURE__ */ jsxs27(Card_default, { className: containerClasses, style: styles.card, variant, children: [
      /* @__PURE__ */ jsxs27(Card_default.Header, { style: styles.header, children: [
        /* @__PURE__ */ jsx53(Card_default.Title, { level: 2, children: flowTitle || t("signin.title") }),
        flowSubtitle && /* @__PURE__ */ jsx53(Typography_default, { variant: "body1", style: styles.subtitle, children: flowSubtitle || t("signin.subtitle") }),
        flowMessages && flowMessages.length > 0 && /* @__PURE__ */ jsx53("div", { style: styles.messagesContainer, children: flowMessages.map((flowMessage, index) => /* @__PURE__ */ jsx53(
          Alert_default,
          {
            variant: flowMessage.type,
            style: styles.messageItem,
            className: messageClasses,
            children: /* @__PURE__ */ jsx53(Alert_default.Description, { children: flowMessage.message })
          },
          flowMessage.id || index
        )) }),
        messages.length > 0 && /* @__PURE__ */ jsx53("div", { style: styles.messagesContainer, children: messages.map((message, index) => {
          ...
          return /* @__PURE__ */ jsx53(Alert_default, { variant: variant2, style: styles.messageItem, className: messageClasses, children: /* @__PURE__ */ jsx53(Alert_default.Description, { children: message.message }) }, index);
        }) })
      ] }),
      /* @__PURE__ */ jsxs27(Card_default.Content, { children: [
        error && /* @__PURE__ */ jsxs27(Alert_default, { variant: "error", style: styles.errorContainer, className: errorClasses, children: [
          /* @__PURE__ */ jsx53(Alert_default.Title, { children: "Error" }),
          /* @__PURE__ */ jsx53(Alert_default.Description, { children: error })
        ] }),
        /* @__PURE__ */ jsxs27("div", { style: styles.contentContainer, children: [
          userPromptAuthenticators.map((authenticator, index) => /* @__PURE__ */ jsxs27("div", { children: [
            index > 0 && /* @__PURE__ */ jsx53(Divider_default, { style: styles.divider, children: "OR" }),
            /* @__PURE__ */ jsx53(
              "form",
              {
                onSubmit: (e) => {
          ...
          userPromptAuthenticators.length > 0 && optionAuthenticators.length > 0 && /* @__PURE__ */ jsx53(Divider_default, { style: styles.divider, children: "OR" }),
          optionAuthenticators.map((authenticator, index) => /* @__PURE__ */ jsx53("div", { children: createSignInOptionFromAuthenticator(
            authenticator,
            formValues,
            touchedFields,
            isLoading,
  ...
  if (!currentAuthenticator) {
    return /* @__PURE__ */ jsx53(Card_default, { className: containerClasses, variant, children: /* @__PURE__ */ jsx53(Card_default.Content, { children: error && /* @__PURE__ */ jsxs27(Alert_default, { variant: "error", children: [
      /* @__PURE__ */ jsx53(Alert_default.Title, { children: t("errors.title") || "Error" }),
      /* @__PURE__ */ jsx53(Alert_default.Description, { children: error })
    ] }) }) });
  }
  if (isPasskeyAuthenticator(currentAuthenticator) && !isLoading) {
    ...
    return /* @__PURE__ */ jsx53(Card_default, { className: containerClasses, variant, children: /* @__PURE__ */ jsx53(Card_default.Content, { children: /* @__PURE__ */ jsxs27("div", { style: styles.centeredContainer, children: [
      /* @__PURE__ */ jsx53("div", { style: styles.passkeyContainer, children: /* @__PURE__ */ jsx53(Spinner_default, { size: "large" }) }),
      /* @__PURE__ */ jsx53(Typography_default, { variant: "body1", children: t("passkey.authenticating") || "Authenticating with passkey..." }),
      /* @__PURE__ */ jsx53(Typography_default, { variant: "body2", style: styles.passkeyText, children: t("passkey.instruction") || "Please use your fingerprint, face, or security key to authenticate." })
    ] }) }) });
  }
  return /* @__PURE__ */ jsxs27(Card_default, { className: containerClasses, style: styles.card, variant, children: [
    /* @__PURE__ */ jsxs27(Card_default.Header, { style: styles.header, children: [
      /* @__PURE__ */ jsx53(Card_default.Title, { level: 2, children: flowTitle || t("signin.title") }),
      /* @__PURE__ */ jsx53(Typography_default, { variant: "body1", style: styles.subtitle, children: flowSubtitle || t("signin.subtitle") }),
      flowMessages && flowMessages.length > 0 && /* @__PURE__ */ jsx53("div", { style: styles.messagesContainer, children: flowMessages.map((flowMessage, index) => /* @__PURE__ */ jsx53(
        Alert_default,
        {
          variant: flowMessage.type,
    ...
    /* @__PURE__ */ jsxs27(Card_default.Content, { children: [
      error && /* @__PURE__ */ jsxs27(Alert_default, { variant: "error", style: styles.errorContainer, className: errorClasses, children: [
        /* @__PURE__ */ jsx53(Alert_default.Title, { children: t("errors.title") }),
        /* @__PURE__ */ jsx53(Alert_default.Description, { children: error })
      ] }),
      /* @__PURE__ */ jsx53(
        "form",
...
import {
  ...
  withVendorCSSClassPrefix as withVendorCSSClassPrefix17,
  AsgardeoAPIError as AsgardeoAPIError3
} from "@asgardeo/browser";
import { clsx as clsx17 } from "clsx";
import { useEffect as useEffect13, useState as useState15, useCallback as useCallback10, useRef as useRef4, useMemo as useMemo13 } from "react";
...
import { FieldType as FieldType7 } from "@asgardeo/browser";
var CheckboxInput = ({
  component,
  formValues,
  touchedFields,
...
import { FieldType as FieldType9 } from "@asgardeo/browser";
var EmailInput = ({
  component,
  formValues,
  touchedFields,
...
var FormContainer = (props) => {
  ...
  if (component.components && component.components.length > 0) {
    ...
    return /* @__PURE__ */ jsx56("form", { onSubmit: handleFormSubmit, style: { display: "flex", flexDirection: "column" }, children: component.components.map(
  ...
  return /* @__PURE__ */ jsx56("div", {}, component.id);
};
...
var GoogleButton2 = ({
  ...
  return /* @__PURE__ */ jsx57(
    Button_default,
    {
      ...
      className: buttonClassName,
      style: { width: "100%" },
      startIcon: /* @__PURE__ */ jsx57("svg", { width: "18", height: "18", viewBox: "0 0 67.91 67.901", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxs28("g", { transform: "translate(-0.001 -0.001)", children: [
        /* @__PURE__ */ jsx57(
          "path",
          {
            d: "M15.049,160.965l-2.364,8.824-8.639.183a34.011,34.011,0,0,1-.25-31.7h0l7.691,1.41,3.369,7.645a20.262,20.262,0,0,0,.19,13.642Z",
...
import { FieldType as FieldType10 } from "@asgardeo/browser";
var NumberInput = ({
  component,
  formValues,
  touchedFields,
...
import { FieldType as FieldType11 } from "@asgardeo/browser";
var PasswordInput = ({
  component,
  formValues,
  touchedFields,
...
import { FieldType as FieldType12 } from "@asgardeo/browser";
var TextInput = ({
  component,
  formValues,
  touchedFields,
...
var BaseSignUp = (props) => {
  ...
  return /* @__PURE__ */ jsxs29("div", { children: [
    /* @__PURE__ */ jsx63("div", { style: styles.logoContainer, children: /* @__PURE__ */ jsx63(Logo_default, { size: "large" }) }),
...
var BaseSignUpContent = ({
  ...
  const [isFlowInitialized, setIsFlowInitialized] = useState15(false);
  const [currentFlow, setCurrentFlow] = useState15(null);
    ...
    (components) => {
      ...
      const processComponents = (comps) => {
        comps.forEach((component) => {
          if (component.type === EmbeddedFlowComponentType2.Input) {
            const config = component.config || {};
            fields.push({
  ...
  const setupFormFields = useCallback10(
    (flowResponse) => {
  ...
  const containerClasses = clsx17(
    [
      withVendorCSSClassPrefix17("signup"),
      withVendorCSSClassPrefix17(`signup--${size}`),
      withVendorCSSClassPrefix17(`signup--${variant}`)
    ],
    className
  );
  const inputClasses = clsx17(
    [
      withVendorCSSClassPrefix17("signup__input"),
      size === "small" && withVendorCSSClassPrefix17("signup__input--small"),
      size === "large" && withVendorCSSClassPrefix17("signup__input--large")
    ],
    inputClassName
  );
  const buttonClasses = clsx17(
    [
      withVendorCSSClassPrefix17("signup__button"),
      size === "small" && withVendorCSSClassPrefix17("signup__button--small"),
      size === "large" && withVendorCSSClassPrefix17("signup__button--large")
    ],
    buttonClassName
  );
  const errorClasses = clsx17([withVendorCSSClassPrefix17("signup__error")], errorClassName);
  const messageClasses = clsx17([withVendorCSSClassPrefix17("signup__messages")], messageClassName);
  const renderComponents = useCallback10(
  ...
  if (!isFlowInitialized && isLoading) {
    return /* @__PURE__ */ jsx63(Card_default, { className: containerClasses, style: styles.card, variant, children: /* @__PURE__ */ jsx63(Card_default.Content, { children: /* @__PURE__ */ jsx63("div", { style: { display: "flex", justifyContent: "center", padding: `calc(${theme.vars.spacing.unit} * 4)` }, children: /* @__PURE__ */ jsx63(Spinner_default, { size: "medium" }) }) }) });
  }
  if (!currentFlow) {
    return /* @__PURE__ */ jsx63(Card_default, { className: containerClasses, style: styles.card, variant, children: /* @__PURE__ */ jsx63(Card_default.Content, { children: /* @__PURE__ */ jsxs29(Alert_default, { variant: "error", className: errorClasses, children: [
  ...
  return /* @__PURE__ */ jsxs29(Card_default, { className: containerClasses, style: styles.card, variant, children: [
    flowMessages && flowMessages.length > 0 && /* @__PURE__ */ jsx63(Card_default.Header, { style: styles.header, children: /* @__PURE__ */ jsx63("div", { style: { marginTop: `calc(${theme.vars.spacing.unit} * 2)` }, children: flowMessages.map((message, index) => /* @__PURE__ */ jsx63(
      Alert_default,
      {
    ...
    /* @__PURE__ */ jsxs29(Card_default.Content, { children: [
      ...
      /* @__PURE__ */ jsx63("div", { style: { display: "flex", flexDirection: "column", gap: `calc(${theme.vars.spacing.unit} * 2)` }, children: currentFlow.data?.components && renderComponents(currentFlow.data.components) })
    ] })
  ] });
};
...
var SignUp = ({
  ...
  const handleComplete = (response) => {
    onComplete?.(response);
    if (shouldRedirectAfterSignUp && response?.type !== EmbeddedFlowResponseType2.Redirection && afterSignUpUrl) {
      window.location.href = afterSignUpUrl;
    }
    if (shouldRedirectAfterSignUp && response?.type === EmbeddedFlowResponseType2.Redirection && response?.data?.redirectURL && !response.data.redirectURL.includes("oauth") && // Not a social provider redirect
...
import { Fragment as Fragment15, jsx as jsx65 } from "react/jsx-runtime";
var BaseUser = ({ user, children, fallback = null }) => {
  if (!user) {
    return /* @__PURE__ */ jsx65(Fragment15, { children: fallback });
  }
  return /* @__PURE__ */ jsx65(Fragment15, { children: children(user) });
};
...
import { Fragment as Fragment16, jsx as jsx67 } from "react/jsx-runtime";
var BaseOrganization = ({ children, fallback = null, organization }) => {
  if (!organization) {
    return /* @__PURE__ */ jsx67(Fragment16, { children: fallback });
  }
  return /* @__PURE__ */ jsx67(Fragment16, { children: children(organization) });
};
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix21, WellKnownSchemaIds } from "@asgardeo/browser";
import clsx21 from "clsx";
import { useMemo as useMemo17, useState as useState17, useCallback as useCallback12, useRef as useRef5 } from "react";
...
var Avatar = ({
  ...
  const backgroundColor = useMemo14(() => {
    if (!name || imageUrl) {
      return void 0;
    }
  ...
  const renderContent = () => {
    if (imageUrl) {
      return /* @__PURE__ */ jsx69("img", { src: imageUrl, alt, style: styles.image });
    }
    if (name) {
  ...
  return /* @__PURE__ */ jsxs30("div", { style: styles.avatar, className: clsx18(withVendorCSSClassPrefix18("avatar"), className), children: [
    /* @__PURE__ */ jsx69("style", { children: `
...
import { withVendorCSSClassPrefix as withVendorCSSClassPrefix19 } from "@asgardeo/browser";
import {
  useFloating,
  autoUpdate,
  offset,
...
var Plus = (props) => /* @__PURE__ */ jsxs32(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
var User7 = (props) => /* @__PURE__ */ jsxs33(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
var DialogContent = React.forwardRef((props, propRef) => {
  ...
  return /* @__PURE__ */ jsx74(FloatingPortal, { children: /* @__PURE__ */ jsx74(FloatingOverlay, { className: withVendorCSSClassPrefix19("popover-overlay"), style: styles.overlay, lockScroll: true, children: /* @__PURE__ */ jsx74(FloatingFocusManager, { context: floatingContext, children: /* @__PURE__ */ jsx74(
    "div",
    {
      ref,
      style: styles.content,
      className: clsx19(withVendorCSSClassPrefix19("popover-content"), props.className),
...
function Popover({ children, ...options }) {
  ...
  return /* @__PURE__ */ jsx74(PopoverContext.Provider, { value: popover, children });
}
...
var PopoverContent = React.forwardRef((props, propRef) => {
  const { context: floatingContext, ...context } = usePopoverContext();
  const ref = useMergeRefs([context.refs.setFloating, propRef]);
  const styles = useStyles5();
  if (!floatingContext.open) return null;
  return /* @__PURE__ */ jsx74(FloatingPortal, { children: /* @__PURE__ */ jsx74(FloatingFocusManager, { context: floatingContext, children: /* @__PURE__ */ jsx74(
    "div",
    {
      ref,
...
var PopoverHeading = React.forwardRef(
  ({ children, ...props }, ref) => {
    const context = usePopoverContext();
    const styles = useStyles5();
    const id = useId();
    ...
    return /* @__PURE__ */ jsxs35("div", { style: styles.header, children: [
      /* @__PURE__ */ jsx74("h2", { ...props, ref, id, style: styles.headerTitle, children }),
      /* @__PURE__ */ jsx74(Button_default, { color: "tertiary", variant: "text", size: "small", onClick: () => context.setOpen(false), "aria-label": "Close", children: /* @__PURE__ */ jsx74(X_default, { width: 16, height: 16 }) })
    ] });
  }
);
var DialogHeading = React.forwardRef(
  ({ children, ...props }, ref) => {
    const context = useDialogContext();
    const styles = useStyles5();
    const id = useId();
...
var PopoverDescription = React.forwardRef(
  ({ children, ...props }, ref) => {
    const context = usePopoverContext();
    const id = useId();
    React.useLayoutEffect(() => {
    ...
    return /* @__PURE__ */ jsx74("p", { ...props, ref, id, children });
  }
);
...
var PopoverClose = React.forwardRef(
  (props, ref) => {
    const context = usePopoverContext();
    return /* @__PURE__ */ jsx74("button", { type: "button", ...props, ref, onClick: () => context.setOpen(false) });
  }
);
...
var LegacyPopoverHeader = ({ children }) => {
  const styles = useStyles5();
  return /* @__PURE__ */ jsx74("div", { style: styles.header, children: children && /* @__PURE__ */ jsx74("h3", { style: styles.headerTitle, children }) });
};
var LegacyPopoverContent = ({ children }) => {
  const styles = useStyles5();
  return /* @__PURE__ */ jsx74("div", { style: styles.contentBody, children });
};
var LegacyPopover = ({ isOpen, children, onClose, className = "", mode = "modal", trigger, placement, offset: offset4 }) => {
  if (mode === "modal") {
    return /* @__PURE__ */ jsx74(Dialog, { open: isOpen, onOpenChange: onClose, children: /* @__PURE__ */ jsx74(DialogContent, { className, children }) });
  }
  return /* @__PURE__ */ jsx74(Popover, { open: isOpen, onOpenChange: onClose, placement, offset: offset4, children: /* @__PURE__ */ jsx74(PopoverContent, { className, children }) });
};
...
import { useCallback as useCallback11, useState as useState16, useMemo as useMemo16 } from "react";
...
var MultiInput = ({
  ...
  const PlusIcon = ({ style: style2 }) => /* @__PURE__ */ jsx75(
    "svg",
    {
      width: "16",
      height: "16",
      ...
      strokeLinejoin: "round",
      style: style2,
      children: /* @__PURE__ */ jsx75("path", { d: "M12 5v14M5 12h14" })
    }
  );
  const BinIcon = () => /* @__PURE__ */ jsx75(
    "svg",
    {
      width: "16",
      height: "16",
      ...
      strokeLinecap: "round",
      strokeLinejoin: "round",
      children: /* @__PURE__ */ jsx75("path", { d: "M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6h14ZM10 11v6M14 11v6" })
    }
  );
  ...
  const handleRemoveValue = useCallback11(
    (index) => {
  ...
  const renderInputField = useCallback11(
  ...
  const [currentInputValue, setCurrentInputValue] = useState16("");
  ...
  return /* @__PURE__ */ jsxs36(
    FormControl_default,
    {
      error,
      helperText,
      className: clsx20(withVendorCSSClassPrefix20("multi-input"), className),
      style,
      children: [
        label && /* @__PURE__ */ jsx75(InputLabel_default, { required, error: !!error, children: label }),
        /* @__PURE__ */ jsxs36("div", { style: styles.container, children: [
          /* @__PURE__ */ jsx75("div", { style: styles.inputRow, children: /* @__PURE__ */ jsx75("div", { style: styles.inputWrapper, children: renderInputField(
            currentInputValue,
            setCurrentInputValue,
            canAddMore ? /* @__PURE__ */ jsx75(PlusIcon, { style: styles.plusIcon }) : void 0,
            canAddMore ? handleInputSubmit : void 0
          ) }) }),
          values.length > 0 && /* @__PURE__ */ jsx75("div", { style: styles.listContainer, children: values.map((value, index) => /* @__PURE__ */ jsxs36("div", { style: styles.listItem, children: [
            ...
            canRemove && /* @__PURE__ */ jsx75(
              Button_default,
              {
                ...
                children: /* @__PURE__ */ jsx75(BinIcon, {})
              }
            )
          ] }, index)) })
        ] })
...
// src/components/presentation/UserProfile/BaseUserProfile.tsx
import { Fragment as Fragment17, jsx as jsx76, jsxs as jsxs37 } from "react/jsx-runtime";
var fieldsToSkip = [
  "roles.default",
  "active",
  "groups",
...
var BaseUserProfile = ({
  ...
  const getFieldPlaceholder = useCallback12((schema) => {
  ...
  const ObjectDisplay = ({ data }) => {
    ...
    return /* @__PURE__ */ jsx76("table", { style: { width: "100%", borderCollapse: "collapse" }, children: /* @__PURE__ */ jsx76("tbody", { children: Object.entries(data).map(([key, value]) => /* @__PURE__ */ jsxs37("tr", { style: { borderBottom: `1px solid ${theme.vars.colors.border}` }, children: [
      /* @__PURE__ */ jsx76("td", { style: { padding: theme.vars.spacing.unit, verticalAlign: "top" }, children: /* @__PURE__ */ jsxs37("strong", { children: [
        formatLabel(key),
        ":"
      ] }) }),
      /* @__PURE__ */ jsx76("td", { style: { padding: theme.vars.spacing.unit, verticalAlign: "top" }, children: typeof value === "object" ? /* @__PURE__ */ jsx76(ObjectDisplay, { data: value }) : String(value) })
    ] }, key)) }) });
  };
  ...
  const formatLabel = useCallback12(
  ...
  const renderSchemaField = (schema, isEditing, onEditValue, onStartEdit) => {
    ...
    if (subAttributes && Array.isArray(subAttributes)) {
      return /* @__PURE__ */ jsx76(Fragment17, { children: subAttributes.map((subAttr, index) => /* @__PURE__ */ jsxs37("div", { style: styles.field, children: [
        /* @__PURE__ */ jsx76("span", { style: styles.label, children: subAttr.displayName || subAttr.description || "" }),
        /* @__PURE__ */ jsx76("div", { style: styles.value, children: Array.isArray(subAttr.value) ? subAttr.value.map((item) => typeof item === "object" ? JSON.stringify(item) : String(item)).join(", ") : typeof subAttr.value === "object" ? JSON.stringify(subAttr.value) : String(subAttr.value) })
      ] }, index)) });
    }
    if (Array.isArray(value) || multiValued) {
      ...
      if (isEditing && onEditValue && isEditable2) {
        ...
        return /* @__PURE__ */ jsxs37(Fragment17, { children: [
          /* @__PURE__ */ jsx76("span", { style: styles.label, children: label }),
          /* @__PURE__ */ jsx76("div", { style: styles.value, children: /* @__PURE__ */ jsx76(
            MultiInput_default,
            {
              values: fieldValues,
              onChange: (newValues) => {
      ...
      return /* @__PURE__ */ jsxs37(Fragment17, { children: [
        /* @__PURE__ */ jsx76("span", { style: styles.label, children: label }),
        /* @__PURE__ */ jsx76("div", { style: { ...styles.value, fontStyle: hasValues ? "normal" : "italic", opacity: hasValues ? 1 : 0.7 }, children: !hasValues && isEditable2 && onStartEdit ? /* @__PURE__ */ jsx76(
          Button_default,
          {
            onClick: onStartEdit,
            variant: "text",
    ...
    if (isEditing && onEditValue && mutability !== "READ_ONLY" && !readonlyFields.includes(name || "")) {
      ...
      return /* @__PURE__ */ jsxs37(Fragment17, { children: [
        /* @__PURE__ */ jsx76("span", { style: styles.label, children: label }),
        /* @__PURE__ */ jsx76("div", { style: styles.value, children: field })
      ] });
    }
    ...
    return /* @__PURE__ */ jsxs37(Fragment17, { children: [
      /* @__PURE__ */ jsx76("span", { style: styles.label, children: label }),
      /* @__PURE__ */ jsx76("div", { style: { ...styles.value, fontStyle: hasValue ? "normal" : "italic", opacity: hasValue ? 1 : 0.7 }, children: !hasValue && isEditable && onStartEdit ? /* @__PURE__ */ jsx76(
        Button_default,
        {
          onClick: onStartEdit,
          variant: "text",
  ...
  const renderUserInfo = (schema) => {
    ...
    return /* @__PURE__ */ jsxs37("div", { style: fieldStyle, children: [
      /* @__PURE__ */ jsx76("div", { style: { flex: 1, display: "flex", alignItems: "center", gap: theme.vars.spacing.unit }, children: renderSchemaField(
        schema,
        isFieldEditing,
        (value) => {
      ...
      editable && schema.mutability !== "READ_ONLY" && !isReadonlyField && /* @__PURE__ */ jsxs37(
        "div",
        {
          style: {
            display: "flex",
          ...
          children: [
            isFieldEditing && /* @__PURE__ */ jsxs37(Fragment17, { children: [
  ...
  const renderProfileWithoutSchemas = () => {
    ...
    return /* @__PURE__ */ jsx76(Fragment17, { children: profileEntries.map(([key, value]) => /* @__PURE__ */ jsxs37("div", { style: styles.field, children: [
      /* @__PURE__ */ jsx76("span", { style: styles.label, children: formatLabel(key) }),
      /* @__PURE__ */ jsx76("div", { style: styles.value, children: typeof value === "object" ? JSON.stringify(value, null, 2) : String(value) })
    ] }, key)) });
  };
  const profileContent = /* @__PURE__ */ jsxs37(Card_default, { style: containerStyle, className: clsx21(withVendorCSSClassPrefix21("user-profile"), className), children: [
    /* @__PURE__ */ jsx76("div", { style: styles.header, children: /* @__PURE__ */ jsx76(
      Avatar,
      {
    ...
    /* @__PURE__ */ jsx76("div", { style: styles.infoContainer, children: schemas && schemas.length > 0 ? (
      ...
      schemas.filter((schema) => {
        ...
        return /* @__PURE__ */ jsx76("div", { children: renderUserInfo(schemaWithValue) }, schema.name || index);
      })
    ) : (
  ...
  if (mode === "popup") {
    return /* @__PURE__ */ jsx76(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs37(DialogContent, { children: [
      /* @__PURE__ */ jsx76(DialogHeading, { children: title }),
      /* @__PURE__ */ jsx76("div", { style: { padding: `calc(${theme.vars.spacing.unit} * 2)` }, children: profileContent })
    ] }) });
  }
...
import { useMemo as useMemo18, useState as useState18 } from "react";
...
var BaseUserDropdown = ({
  ...
  const [hoveredItemIndex, setHoveredItemIndex] = useState18(null);
  const { theme, colorScheme } = useTheme_default();
  ...
  const { getReferenceProps, getFloatingProps } = useInteractions2([click, dismiss, role]);
  const defaultAttributeMappings = {
    picture: ["profile", "profileUrl", "picture", "URL"],
    firstName: ["name.givenName", "given_name"],
    lastName: ["name.familyName", "family_name"],
  ...
  return /* @__PURE__ */ jsxs38("div", { className: clsx22(withVendorCSSClassPrefix22("user-dropdown"), className), children: [
    /* @__PURE__ */ jsxs38(
      Button_default,
      {
        ref: refs.setReference,
        className: withVendorCSSClassPrefix22("user-dropdown__trigger"),
        ...
        children: [
          ...
          showTriggerLabel && /* @__PURE__ */ jsx78(
            ...
            {
              variant: "body2",
              className: withVendorCSSClassPrefix22("user-dropdown__trigger-label"),
    ...
    isOpen && /* @__PURE__ */ jsx78(FloatingPortal2, { id: portalId, children: /* @__PURE__ */ jsx78(FloatingFocusManager2, { context, modal: false, children: /* @__PURE__ */ jsxs38(
      "div",
      {
        ref: refs.setFloating,
        className: withVendorCSSClassPrefix22("user-dropdown__content"),
        style: { ...floatingStyles, ...styles.dropdownContent },
        ...getFloatingProps(),
        children: [
          /* @__PURE__ */ jsxs38("div", { className: withVendorCSSClassPrefix22("user-dropdown__header"), style: styles.dropdownHeader, children: [
            /* @__PURE__ */ jsx78(
              Avatar,
              {
                imageUrl: getMappedUserProfileValue_default("picture", mergedMappings, user),
            ...
            /* @__PURE__ */ jsxs38("div", { className: withVendorCSSClassPrefix22("user-dropdown__header-info"), style: styles.headerInfo, children: [
              /* @__PURE__ */ jsx78(
                Typography_default,
                {
                  noWrap: true,
                  className: withVendorCSSClassPrefix22("user-dropdown__header-name"),
                  variant: "body1",
                  fontWeight: "medium",
                  children: getDisplayName()
                }
              ...
              /* @__PURE__ */ jsx78(
                ...
                {
                  noWrap: true,
                  className: withVendorCSSClassPrefix22("user-dropdown__header-email"),
                  variant: "caption",
                  color: "secondary",
          ...
          /* @__PURE__ */ jsx78("div", { className: withVendorCSSClassPrefix22("user-dropdown__menu"), style: styles.dropdownMenu, children: allMenuItems.map((item, index) => /* @__PURE__ */ jsx78("div", { children: item.label === "" ? (
            // Render divider for empty label placeholder
            /* @__PURE__ */ jsx78("div", { className: withVendorCSSClassPrefix22("user-dropdown__menu-divider"), style: styles.divider })
            ...
            "a",
            {
              ...
              className: withVendorCSSClassPrefix22("user-dropdown__menu-item"),
...
import { Fragment as Fragment18, jsx as jsx79, jsxs as jsxs39 } from "react/jsx-runtime";
var UserDropdown = ({
  children,
  renderTrigger,
  renderDropdown,
  ...
  const [isProfileOpen, setIsProfileOpen] = useState19(false);
...
import { useMemo as useMemo19, useState as useState20 } from "react";

// src/components/primitives/Icons/Building.tsx
import { jsx as jsx80, jsxs as jsxs40 } from "react/jsx-runtime";
var Building = ({ color = "currentColor", height = 24, width = 24 }) => /* @__PURE__ */ jsxs40("svg", { width, height, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsx80(
    "path",
    {
...
// src/components/presentation/OrganizationSwitcher/BaseOrganizationSwitcher.tsx
import { Fragment as Fragment19, jsx as jsx83, jsxs as jsxs41 } from "react/jsx-runtime";
var useStyles9 = () => {
  const { theme, colorScheme } = useTheme_default();
  return useMemo19(
    () => ({
...
var BaseOrganizationSwitcher = ({
  ...
  const [hoveredItemIndex, setHoveredItemIndex] = useState20(null);
  const { theme, colorScheme } = useTheme_default();
  const { t } = useTranslation_default();
  const { refs, floatingStyles, context } = useFloating3({
    ...
    onOpenChange: setIsOpen,
    placement: "bottom-end",
    middleware: [offset3(5), flip3({ fallbackAxisSideDirection: "end" }), shift3({ padding: 5 })],
    whileElementsMounted: autoUpdate3
  });
  const click = useClick3(context);
  const dismiss = useDismiss3(context);
  const role = useRole3(context);
  const { getReferenceProps, getFloatingProps } = useInteractions3([click, dismiss, role]);
  ...
  const defaultRenderOrganization2 = (organization, isSelected) => /* @__PURE__ */ jsxs41(Fragment19, { children: [
    /* @__PURE__ */ jsx83(
      Avatar,
      {
        variant: "square",
    ...
    /* @__PURE__ */ jsxs41("div", { style: styles.organizationInfo, children: [
      /* @__PURE__ */ jsx83(Typography_default, { variant: "body2", fontWeight: "medium", style: styles.organizationName, children: organization.name }),
      /* @__PURE__ */ jsxs41("div", { style: styles.organizationMeta, children: [
        showMemberCount && organization.memberCount !== void 0 && /* @__PURE__ */ jsxs41("span", { children: [
        ...
        showRole && organization.role && /* @__PURE__ */ jsx83("span", { style: styles.roleCapitalized, children: organization.role })
      ] })
    ] }),
    isSelected && /* @__PURE__ */ jsx83(Check_default, { width: "16", height: "16", color: theme.vars.colors.text.primary })
  ] });
  const defaultRenderLoading2 = () => /* @__PURE__ */ jsx83("div", { style: styles.loadingContainer, children: /* @__PURE__ */ jsx83(Typography_default, { variant: "caption", style: styles.loadingText, children: t("organization.switcher.loading.organizations") }) });
  const defaultRenderError2 = (errorMessage) => /* @__PURE__ */ jsx83("div", { style: styles.errorContainer, children: /* @__PURE__ */ jsx83(Typography_default, { variant: "caption", style: styles.errorText, children: errorMessage }) });
  return /* @__PURE__ */ jsxs41("div", { className: clsx23(withVendorCSSClassPrefix23("organization-switcher"), className), style, children: [
    /* @__PURE__ */ jsxs41(
      Button_default,
      {
        ref: refs.setReference,
        className: withVendorCSSClassPrefix23("organization-switcher__trigger"),
        style: styles.trigger,
        color: "tertiary",
        variant: "outline",
        size: "medium",
        ...getReferenceProps(),
        children: [
          currentOrganization ? /* @__PURE__ */ jsxs41(Fragment19, { children: [
            /* @__PURE__ */ jsx83(
              Avatar,
              {
                variant: "square",
            ...
            showTriggerLabel && /* @__PURE__ */ jsx83(
              Typography_default,
              {
                variant: "body2",
                className: withVendorCSSClassPrefix23("organization-switcher__trigger-label"),
    ...
    isOpen && /* @__PURE__ */ jsx83(FloatingPortal3, { id: portalId, children: /* @__PURE__ */ jsx83(FloatingFocusManager3, { context, modal: false, children: /* @__PURE__ */ jsxs41(
      "div",
      {
        ref: refs.setFloating,
        className: withVendorCSSClassPrefix23("organization-switcher__content"),
        style: { ...floatingStyles, ...styles.dropdownContent },
        ...getFloatingProps(),
        children: [
          currentOrganization && /* @__PURE__ */ jsxs41(
            "div",
            {
              className: withVendorCSSClassPrefix23("organization-switcher__header"),
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs41(
                  "div",
                  {
                    className: withVendorCSSClassPrefix23("organization-switcher__header-info"),
                    ...
                    children: [
                      /* @__PURE__ */ jsx83(
                        ...
                        {
                          noWrap: true,
                          className: withVendorCSSClassPrefix23("organization-switcher__header-name"),
                          variant: "body1",
                          fontWeight: "medium",
                      ...
                      /* @__PURE__ */ jsxs41("div", { style: styles.organizationMeta, children: [
                        showMemberCount && currentOrganization.memberCount !== void 0 && /* @__PURE__ */ jsxs41(
                          Typography_default,
                          {
                            noWrap: true,
                            className: withVendorCSSClassPrefix23("organization-switcher__header-meta"),
                            variant: "caption",
                            color: "secondary",
                            children: [
                              ...
                              showRole && currentOrganization.role && /* @__PURE__ */ jsxs41("span", { children: [
                                " \u2022 ",
                        ...
                        showRole && currentOrganization.role && (!showMemberCount || currentOrganization.memberCount === void 0) && /* @__PURE__ */ jsx83(
                          Typography_default,
                          {
                            noWrap: true,
                            className: withVendorCSSClassPrefix23("organization-switcher__header-role"),
                            variant: "caption",
                            color: "secondary",
          ...
          organizations.length > 1 && /* @__PURE__ */ jsx83(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx83(Typography_default, { variant: "caption", fontWeight: 600, style: styles.sectionHeader, children: t("organization.switcher.switch.organization") })
            }
          ),
          /* @__PURE__ */ jsx83("div", { className: withVendorCSSClassPrefix23("organization-switcher__menu"), style: styles.dropdownMenu, children: loading ? renderLoading ? renderLoading() : defaultRenderLoading2() : error ? renderError ? renderError(error) : defaultRenderError2(error) : /* @__PURE__ */ jsxs41(Fragment19, { children: [
            switchableOrganizations.map((organization) => {
              ...
              return /* @__PURE__ */ jsx83(
                Button_default,
                {
                  ...
                  className: withVendorCSSClassPrefix23("organization-switcher__menu-item"),
                  color: "tertiary",
                  variant: "text",
                  size: "small",
                  style: {
            ...
            menuItems.length > 0 && /* @__PURE__ */ jsxs41(Fragment19, { children: [
              /* @__PURE__ */ jsx83(
                "div",
                {
                  className: withVendorCSSClassPrefix23("organization-switcher__menu-divider"),
                  style: styles.divider
                }
              ),
              menuItems.map(
                (item, index) => /* @__PURE__ */ jsx83("div", { children: item.href ? /* @__PURE__ */ jsxs41(
                  "a",
                  {
                    href: item.href,
                    style: {
...
import { useMemo as useMemo20, useState as useState21 } from "react";
...
var BaseCreateOrganization = ({
  ...
  const createOrganizationContent = /* @__PURE__ */ jsx84(
    "div",
    {
      className: clsx24(withVendorCSSClassPrefix24("create-organization"), className),
      style: { ...containerStyle, ...style },
      children: /* @__PURE__ */ jsxs42("div", { className: withVendorCSSClassPrefix24("create-organization__content"), style: styles.content, children: [
        /* @__PURE__ */ jsxs42(
          "form",
          {
            id: "create-organization-form",
            className: withVendorCSSClassPrefix24("create-organization__form"),
            style: styles.form,
            onSubmit: handleSubmit,
            children: [
              error && /* @__PURE__ */ jsxs42(Alert_default, { variant: "error", style: { marginBottom: `calc(${theme.vars.spacing.unit} * 2)` }, children: [
                /* @__PURE__ */ jsx84(Alert_default.Title, { children: "Error" }),
                /* @__PURE__ */ jsx84(Alert_default.Description, { children: error })
              ] }),
              /* @__PURE__ */ jsx84("div", { className: withVendorCSSClassPrefix24("create-organization__field-group"), children: /* @__PURE__ */ jsx84(
                TextField_default,
                {
                  ...
                  className: withVendorCSSClassPrefix24("create-organization__input")
                }
              ) }),
              /* @__PURE__ */ jsx84("div", { className: withVendorCSSClassPrefix24("create-organization__field-group"), children: /* @__PURE__ */ jsx84(
                TextField_default,
              ...
              /* @__PURE__ */ jsx84("div", { className: withVendorCSSClassPrefix24("create-organization__field-group"), children: /* @__PURE__ */ jsxs42(FormControl_default, { error: formErrors.description, children: [
                /* @__PURE__ */ jsx84(InputLabel_default, { required: true, children: t("organization.create.description.label") }),
                /* @__PURE__ */ jsx84(
                  "textarea",
                  {
                    className: withVendorCSSClassPrefix24("create-organization__textarea"),
                    style: {
                      ...styles.textarea,
        ...
        /* @__PURE__ */ jsxs42("div", { className: withVendorCSSClassPrefix24("create-organization__actions"), style: styles.actions, children: [
  ...
  if (mode === "popup") {
    return /* @__PURE__ */ jsx84(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs42(DialogContent, { children: [
      /* @__PURE__ */ jsx84(DialogHeading, { children: title }),
      /* @__PURE__ */ jsx84("div", { style: { padding: `calc(${theme.vars.spacing.unit} * 2)` }, children: createOrganizationContent })
    ] }) });
  }
...
var CreateOrganization = ({
  ...
  if (!isSignedIn) {
    return /* @__PURE__ */ jsx85(Fragment20, {});
  }
...
import { useMemo as useMemo21, useState as useState24, useCallback as useCallback14, useRef as useRef7 } from "react";
...
import { useState as useState23, useCallback as useCallback13 } from "react";
...
var KeyValueInput = ({
  ...
  const [pairs, setPairs] = useState23(initialPairs);
  const [newKey, setNewKey] = useState23("");
  const [newValue, setNewValue] = useState23("");
  const handleAddPair = useCallback13(() => {
  ...
  const handleRemovePair = useCallback13(
    (index) => {
  ...
  const handleUpdatePair = useCallback13(
    (index, field, newVal) => {
  ...
  return /* @__PURE__ */ jsxs43("div", { className: clsx25(withVendorCSSClassPrefix25("key-value-input"), className), style: styles.container, children: [
    label && /* @__PURE__ */ jsxs43("label", { style: styles.label, children: [
      label,
      required && /* @__PURE__ */ jsx86("span", { style: { color: theme.vars.colors.error.main }, children: " *" })
    ] }),
    /* @__PURE__ */ jsxs43("div", { style: styles.pairsList, children: [
      pairs.length === 0 && readOnly ? /* @__PURE__ */ jsx86("div", { style: styles.emptyState, children: "No attributes defined" }) : readOnly ? pairs.map((pair, index) => /* @__PURE__ */ jsxs43("div", { style: styles.readOnlyPair, children: [
        /* @__PURE__ */ jsxs43("span", { style: styles.readOnlyKey, children: [
          pair.key,
          ":"
        ] }),
        /* @__PURE__ */ jsx86("span", { style: styles.readOnlyValue, children: pair.value })
      ] }, `${pair.key}-${index}`)) : pairs.map((pair, index) => /* @__PURE__ */ jsxs43("div", { style: styles.pairRow, children: [
        /* @__PURE__ */ jsx86(
          TextField_default,
          {
      ...
      !readOnly && /* @__PURE__ */ jsxs43("div", { style: styles.addRow, children: [
        /* @__PURE__ */ jsx86(
          TextField_default,
          {
            placeholder: keyPlaceholder,
    ...
    (helperText || error) && /* @__PURE__ */ jsx86("div", { style: styles.helperText, children: error || helperText }),
    maxPairs && /* @__PURE__ */ jsxs43("div", { style: styles.helperText, children: [
      pairs.length,
      " of ",
      maxPairs,
      " pairs used"
...
// src/components/presentation/OrganizationProfile/BaseOrganizationProfile.tsx
import { Fragment as Fragment21, jsx as jsx87, jsxs as jsxs44 } from "react/jsx-runtime";
...
var BaseOrganizationProfile = ({
  ...
  const { theme } = useTheme_default();
  const [editedOrganization, setEditedOrganization] = useState24(organization);
  ...
  const getFieldPlaceholder = useCallback14((fieldKey) => {
    const fieldLabels = {
      name: "organization name",
  ...
  const renderField = (field, isEditing, onEditValue, onStartEdit) => {
    ...
    if (isEditing && onEditValue && fieldEditable && editable) {
      ...
      return /* @__PURE__ */ jsxs44(Fragment21, { children: [
        /* @__PURE__ */ jsx87("span", { style: styles.label, children: label }),
        /* @__PURE__ */ jsx87("div", { style: styles.value, children: fieldInput })
      ] });
    }
    const hasValue = value !== void 0 && value !== null && value !== "";
    ...
    return /* @__PURE__ */ jsxs44(Fragment21, { children: [
      ...
      /* @__PURE__ */ jsx87(
        "div",
        {
          ...
          children: !hasValue && isFieldEditable && onStartEdit ? /* @__PURE__ */ jsx87(
            Button_default,
            {
              onClick: onStartEdit,
              variant: "text",
  ...
  const renderOrganizationField = (field) => {
    ...
    return /* @__PURE__ */ jsxs44("div", { style: fieldStyle, children: [
      /* @__PURE__ */ jsx87("div", { style: { flex: 1, display: "flex", alignItems: "center", gap: theme.vars.spacing.unit }, children: renderField(
        field,
        isFieldEditing,
        (value) => {
      ...
      isFieldEditable && /* @__PURE__ */ jsx87("div", { style: { display: "flex", alignItems: "center", gap: `calc(${theme.vars.spacing.unit} / 2)` }, children: isFieldEditing ? /* @__PURE__ */ jsxs44(Fragment21, { children: [
        /* @__PURE__ */ jsx87(
          Button_default,
          {
  ...
  const profileContent = /* @__PURE__ */ jsxs44(Card_default, { style: containerStyle, className: clsx26(withVendorCSSClassPrefix26("organization-profile"), className), children: [
    /* @__PURE__ */ jsxs44("div", { style: styles.header, children: [
      ...
      /* @__PURE__ */ jsxs44("div", { style: styles.orgInfo, children: [
        /* @__PURE__ */ jsx87("h2", { style: styles.name, children: organization.name }),
        organization.orgHandle && /* @__PURE__ */ jsxs44("p", { style: styles.handle, children: [
          "@",
          organization.orgHandle
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx87("div", { style: styles.infoContainer, children: fields.map((field, index) => renderOrganizationField(field)) })
  ] });
  if (mode === "popup") {
    return /* @__PURE__ */ jsx87(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs44(DialogContent, { children: [
      ...
      /* @__PURE__ */ jsx87("div", { style: { padding: `calc(${theme.vars.spacing.unit} * 2)` }, children: profileContent })
    ] }) });
  }
  return profileContent;
};
...
var OrganizationProfile = ({
  ...
  const { baseUrl } = useAsgardeo_default();
  const { t } = useTranslation_default();
  const [organization, setOrganization] = useState25(null);
  const [loading, setLoading] = useState25(true);
  const [error, setError] = useState25(false);
...
var defaultRenderOrganization = (organization, styles, t, onOrganizationSelect, showStatus) => {
  return /* @__PURE__ */ jsxs45(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs45("div", { style: styles.organizationContent, children: [
          /* @__PURE__ */ jsx89(Avatar_default, { variant: "square", name: organization.name, size: 48, alt: `${organization.name} logo` }),
          /* @__PURE__ */ jsxs45("div", { style: styles.organizationInfo, children: [
            /* @__PURE__ */ jsx89(Typography_default, { variant: "h6", style: styles.organizationName, children: organization.name }),
            /* @__PURE__ */ jsxs45(Typography_default, { variant: "body2", color: "textSecondary", style: styles.organizationHandle, children: [
              "@",
              organization.orgHandle
            ] }),
            showStatus && /* @__PURE__ */ jsxs45(Typography_default, { variant: "body2", color: "textSecondary", style: styles.organizationStatus, children: [
        ...
        organization.canSwitch && /* @__PURE__ */ jsx89("div", { style: styles.organizationActions, children: /* @__PURE__ */ jsx89(
          Button_default,
          {
            onClick: (e) => {
              e.stopPropagation();
...
var defaultRenderLoading = (t, styles) => /* @__PURE__ */ jsxs45("div", { style: styles.loadingContainer, children: [
  /* @__PURE__ */ jsx89(Spinner_default, { size: "medium" }),
  /* @__PURE__ */ jsx89(Typography_default, { variant: "body1", color: "textSecondary", style: styles.loadingText, children: t("organization.switcher.loading.organizations") })
] });
var defaultRenderError = (error, t, styles) => /* @__PURE__ */ jsx89("div", { style: styles.errorContainer, children: /* @__PURE__ */ jsxs45(Typography_default, { variant: "body1", color: "error", children: [
  /* @__PURE__ */ jsx89("strong", { children: t("organization.switcher.error.prefix") }),
  " ",
  error
] }) });
var defaultRenderLoadMore = (onLoadMore, isLoading, t, styles) => /* @__PURE__ */ jsx89(
  Button_default,
  {
    onClick: onLoadMore,
    disabled: isLoading,
...
var defaultRenderEmpty = (t, styles) => /* @__PURE__ */ jsx89("div", { style: styles.emptyContainer, children: /* @__PURE__ */ jsx89(Typography_default, { variant: "body1", color: "textSecondary", style: styles.emptyText, children: t("organization.switcher.no.organizations") }) });
var BaseOrganizationList = ({
  ...
  const { t } = useTranslation_default();
  const organizationsWithSwitchAccess = useMemo22(() => {
  ...
  if (isLoading && organizationsWithSwitchAccess?.length === 0) {
    const loadingContent = /* @__PURE__ */ jsx89(
      "div",
      {
        className: clsx27(withVendorCSSClassPrefix27("organization-list"), className),
        style: { ...styles.root, ...style },
        children: renderLoadingWithStyles()
      }
    );
    if (mode === "popup") {
      return /* @__PURE__ */ jsx89(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs45(DialogContent, { children: [
        /* @__PURE__ */ jsx89(DialogHeading, { children: title }),
        /* @__PURE__ */ jsx89("div", { style: styles.popupContent, children: loadingContent })
      ] }) });
    }
    return loadingContent;
  }
  if (error && organizationsWithSwitchAccess?.length === 0) {
    const errorContent = /* @__PURE__ */ jsx89(
      "div",
      {
        className: clsx27(withVendorCSSClassPrefix27("organization-list"), className),
        style: { ...styles.root, ...style },
    ...
    if (mode === "popup") {
      return /* @__PURE__ */ jsx89(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs45(DialogContent, { children: [
        /* @__PURE__ */ jsx89(DialogHeading, { children: title }),
        /* @__PURE__ */ jsx89("div", { style: styles.popupContent, children: errorContent })
      ] }) });
    }
    return errorContent;
  }
  if (!isLoading && organizationsWithSwitchAccess?.length === 0) {
    const emptyContent = /* @__PURE__ */ jsx89(
      "div",
      {
        className: clsx27(withVendorCSSClassPrefix27("organization-list"), className),
        style: { ...styles.root, ...style },
    ...
    if (mode === "popup") {
      return /* @__PURE__ */ jsx89(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs45(DialogContent, { children: [
        /* @__PURE__ */ jsx89(DialogHeading, { children: title }),
        /* @__PURE__ */ jsx89("div", { style: styles.popupContent, children: emptyContent })
      ] }) });
    }
    return emptyContent;
  }
  const organizationListContent = /* @__PURE__ */ jsxs45("div", { className: clsx27(withVendorCSSClassPrefix27("organization-list"), className), style: { ...styles.root, ...style }, children: [
    /* @__PURE__ */ jsxs45("div", { style: styles.header, children: [
      /* @__PURE__ */ jsx89("div", { style: styles.headerInfo, children: /* @__PURE__ */ jsx89(Typography_default, { variant: "body2", color: "textSecondary", style: styles.subtitle, children: t("organization.switcher.showing.count", {
        showing: organizationsWithSwitchAccess?.length,
        total: allOrganizations?.organizations?.length || 0
      }) }) }),
      onRefresh && /* @__PURE__ */ jsx89(Button_default, { onClick: onRefresh, style: styles.refreshButton, type: "button", variant: "outline", size: "small", children: t("organization.switcher.refresh.button") })
    ] }),
    /* @__PURE__ */ jsx89("div", { style: styles.listContainer, children: organizationsWithSwitchAccess?.map(
      (organization, index) => renderOrganizationWithStyles(organization, index)
    ) }),
    error && organizationsWithSwitchAccess?.length > 0 && /* @__PURE__ */ jsx89("div", { style: styles.errorMargin, children: renderErrorWithStyles(error) }),
    hasMore && fetchMore && /* @__PURE__ */ jsx89("div", { style: styles.loadMoreMargin, children: renderLoadMoreWithStyles(fetchMore, isLoadingMore) })
  ] });
  if (mode === "popup") {
    return /* @__PURE__ */ jsx89(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs45(DialogContent, { children: [
      /* @__PURE__ */ jsx89(DialogHeading, { children: title }),
      /* @__PURE__ */ jsx89("div", { style: styles.popupContent, children: organizationListContent })
    ] }) });
  }
...
var OrganizationList = ({
  ...
  const [allOrganizations, setAllOrganizations] = useState26({
    organizations: []
  });
  useEffect15(() => {
    (async () => {
...
// src/components/presentation/OrganizationSwitcher/OrganizationSwitcher.tsx
import { Fragment as Fragment22, jsx as jsx92, jsxs as jsxs47 } from "react/jsx-runtime";
var OrganizationSwitcher = ({
  ...
  const [isCreateOrgOpen, setIsCreateOrgOpen] = useState27(false);
  const [isProfileOpen, setIsProfileOpen] = useState27(false);
  const [isOrganizationListOpen, setIsOrganizationListOpen] = useState27(false);
  const { t } = useTranslation_default();
  if (!isSignedIn && fallback) {
    return fallback;
  }
  if (!isSignedIn) {
    return /* @__PURE__ */ jsx92(Fragment22, {});
  }
...
export {
  ...
  BaseSignIn_default as BaseSignIn,
  ...
  BrandingContext_default as BrandingContext,
  ...
  I18nContext_default as I18nContext,
  I18nProvider_default as I18nProvider,
  ...
  OrganizationSwitcher_default as OrganizationSwitcher,
  ...
  SmsOtp_default as SmsOtp,
  SocialButton_default as SocialButton,
  Spinner_default as Spinner,
  TextField_default as TextField,
  ThemeContext_default as ThemeContext,
  ThemeProvider_default as ThemeProvider,
  Totp_default as Totp,
  TriangleAlert_default as TriangleAlert,
  Typography_default as Typography,
  User_default as User,
  UserContext_default as UserContext,
  UserDropdown_default as UserDropdown,
  User_default2 as UserIcon,
  ...
  useBranding_default as useBranding,
  useBrandingContext_default as useBrandingContext,
  ...
  useTranslation_default as useTranslation,
