...
/**
         ...
         *
         * @preserve
         */initialize(e,l,i){var n,o,c,d;return t(this,void 0,void 0,(function*(){this._storage=null!==(n=e.storage)&&void 0!==n?n:be.SessionStorage,this._initialized=!1,this._startedInitialize=!0,l&&this.instantiateAuthHelper(l),i&&this.instantiateWorker(i);const t=yield null===(o=this._client)||void 0===o?void 0:o.getConfigData();if(this._storage!==be.WebWorker){const l=e,i=Object.assign({},Lo),n=Object.assign(Object.assign({},i),l);return this._client&&(!this._client||t&&0!==(null===(c=Object.keys(t))||void 0===c?void 0:c.length))||(this._client=yield ko(this._instanceID,n,((e,t)=>new this._authHelper(e,t)))),this._initialized=!0,this._onInitialize&&this._onInitialize(!0),n.autoLogoutOnTokenRefreshError?(window.addEventListener("message",(e=>{var t;(null===(t=null==e?void 0:e.data)||void 0===t?void 0:t.type)===M&&this.signOut()})),Promise.resolve(!0)):Promise.resolve(!0)}if(!this._client||this._client&&(!t||0===(null===(d=Object.keys(t))||void 0===d?void 0:d.length))){const t=e;return this._client=yield fo(this._instanceID,Object.assign(Object.assign({},Lo),t),this._worker,((e,t)=>new this._authHelper(e,t))),this._client.initialize().then((()=>(this._onInitialize&&this._onInitialize(!0),this._initialized=!0,Promise.resolve(!0)))).catch((e=>Promise.reject(e)))}return Promise.resolve(!0)}))}
/**
...
/**
         ...
         *
         * @preserve
         */getIDPAccessToken(){return t(this,void 0,void 0,(function*(){if(yield this._validateMethod(),this._storage&&[(be.WebWorker,be.BrowserMemory)].includes(this._storage))return Promise.reject(new r("SPA-AUTH_CLIENT-GIAT-IV01","The access token cannot be returned.","The access token cannot be returned when the storage type is set to webWorker or browserMemory."));return this._client.getAccessToken()}))}
/**
