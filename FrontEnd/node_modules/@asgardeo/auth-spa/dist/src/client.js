...
export class AsgardeoSPAClient {
    ...
    initialize(config, authHelper, workerFile) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _config = yield ((_b = this._client) === null || _b === void 0 ? void 0 : _b.getConfigData());
            if (!(this._storage === Storage.WebWorker)) {
                const mainThreadClientConfig = config;
                const defaultConfig = Object.assign({}, DefaultConfig);
                const mergedConfig = Object.assign(Object.assign({}, defaultConfig), mainThreadClientConfig);
                ...
                if (!this._client || (this._client && (!_config || ((_c = Object.keys(_config)) === null || _c === void 0 ? void 0 : _c.length) === 0))) {
                    this._client = yield MainThreadClient(this._instanceID, mergedConfig, (authClient, spaHelper) => {
                ...
                // Hence, we need to check if the client is initialized but the config object is empty, and reinitialize.
                // Tracker: https://github.com/asgardeo/asgardeo-auth-react-sdk/issues/240
                if (!this._client || (this._client && (!_config || ((_d = Object.keys(_config)) === null || _d === void 0 ? void 0 : _d.length) === 0))) {
    ...
    signIn(config, authorizationCode, sessionState, state, tokenRequestConfig) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (_a = this._client) === null || _a === void 0 ? void 0 : _a.signIn(config, authorizationCode, sessionState, state, tokenRequestConfig).then((response) => {
    ...
    trySignInSilently(additionalParams, tokenRequestConfig) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (_a = this._client) === null || _a === void 0 ? void 0 : _a.trySignInSilently(additionalParams, tokenRequestConfig).then((response) => {
    ...
    signOut() {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            yield this._validateMethod(false);
    ...
    getConfigData() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return (_a = this._client) === null || _a === void 0 ? void 0 : _a.getConfigData();
        });
    }
    /**
